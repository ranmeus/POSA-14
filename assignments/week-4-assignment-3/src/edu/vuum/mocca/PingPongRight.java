...
public class PingPongRight {
    ...
    public static class PlayPingPongThread extends Thread {
         ...
         */
        // TODO - You fill in here.
        private SimpleSemaphore[] mSSemaphores = new SimpleSemaphore[2];
        ...
        public PlayPingPongThread(String stringToPrint,
        	...
        	mSSemaphores[FIRST_SEMA] = semaphoreOne;
        	mSSemaphores[SECOND_SEMA] = semaphoreTwo;
        ...
        private void acquire() {
            // TODO fill in here
        	mSSemaphores[FIRST_SEMA].acquireUninterruptibly();;
        }
        ...
        private void release() {
            // TODO fill in here
        	mSSemaphores[SECOND_SEMA].release();
        }
    }
